    ...
    class Debug
    {
        ...
        public static void InitialiseTrace()
        {
            ...
            try
            {
                ...
                //TracePath = appDatapath + "\\Corporate Contacts\\Logs";
                ...
                myBoolSwitch = new BooleanSwitch("myBoolSwitch", "CraniumCafe" + " General");
                myTraceSwitch = new System.Diagnostics.TraceSwitch("myTraceSwitch", "CraniumCafe" + "2 General");
                if (!Directory.Exists(TracePath)) Directory.CreateDirectory(TracePath);

                myTraceLog = new FileStream(TracePath + "\\" + "CraniumCafe" + "-Log (" + DateTime.Now.ToString("yy-MM-dd") + ").txt", FileMode.Append);
